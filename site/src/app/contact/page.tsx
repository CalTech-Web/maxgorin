              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all duration-300 text-gray-700"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all duration-300 resize-y text-gray-700"
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 bg-gold hover:bg-gold-dark text-navy-dark font-semibold px-6 py-4 rounded-full transition-all duration-300 hover:shadow-[0_8px_30px_rgba(212,168,67,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {status === "sending" ? (
                    "Sending..."
                  ) : (
